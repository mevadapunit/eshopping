							...
							<div class="d-flex order-lg-2 ms-auto header-right-icons">
								...
								<div class="dropdown d-none d-md-flex">
									<a class="nav-link icon theme-layout nav-link-bg layout-setting">
										<span class="dark-layout" data-bs-placement="bottom" data-bs-toggle="tooltip" title="" data-bs-original-title="Dark Theme" aria-label="Dark Theme"><i class="fe fe-moon"></i></span>
										<span class="light-layout" data-bs-placement="bottom" data-bs-toggle="tooltip" title="" data-bs-original-title="Light Theme" aria-label="Light Theme"><i class="fe fe-sun"></i></span>
									</a>
								</div><!-- Theme-Layout -->
								<div class="dropdown d-none d-md-flex">
								...
								<div class="dropdown  d-none d-md-flex message">
									...
									<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
										...
										<div class="message-menu">
											<a class="dropdown-item d-flex" href="chat.html">
											<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ asset('admin/assets/images/users/1.jpg') }}" style="background: url('{{ asset('admin/images/users/1.jpg') }}') center center;"></span>												
											<div class="wd-90p">
													<div class="d-flex">
											...
											<a class="dropdown-item d-flex" href="chat.html">
												<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ asset('admin/assets/images/users/12.jpg')}}" style="background: url('{{ asset('admin/images/users/12.jpg') }}') center center;"></span>
												<div class="wd-90p">
													<div class="d-flex">
											...
											<a class="dropdown-item d-flex" href="chat.html">
												<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ asset('admin/assets/images/users/4.jpg')}}" style="background: url('{{ asset('admin/images/users/4.jpg') }}') center center;"></span>
												<div class="wd-90p">
													<div class="d-flex">
											...
											<a class="dropdown-item d-flex" href="chat.html">
												<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('admin/assets/images/users/15.jpg')}}" style="background: url('{{ asset('admin/images/users/15.jpg') }}') center center;"></span>
												<div class="wd-90p">
													<div class="d-flex">
							...
							<div class="dropdown d-md-flex message">
								...
								<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
									...
									<div class="message-menu">
										...
										<a class="dropdown-item d-flex" href="chat.html">
											<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('admin/assets/images/users/12.jpg')}}" style="background: url('{{ asset('admin/assets/images/users/12.jpg') }}') center center;"></span>
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1">Anthony</h5>
													<small class="text-muted ms-auto text-end">
										...
										<a class="dropdown-item d-flex" href="chat.html">
											<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('admin/assets/images/users/4.jpg')}}" style="background: url('{{ asset('admin/assets/images/users/4.jpg') }}') center center;"></span>
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1">Olivia</h5>
													<small class="text-muted ms-auto text-end">
										...
										<a class="dropdown-item d-flex" href="chat.html">
											<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('admin/assets/images/users/15.jpg')}}" style="background: url('{{ asset('admin/assets/images/users/15.jpg') }}') center center;"></span>
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1">Sanderson</h5>
													<small class="text-muted ms-auto text-end">
