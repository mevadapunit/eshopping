...
<head>
    ...
    <!-- FAVICON -->
    <link rel="stylesheet" type="image/x-icon"  href="{{asset('admin/assets/images/brand/favicon.ico')}}" />
    ...
    <!-- SIDE-MENU CSS -->
    <link href="{{asset('admin/assets/css/sidemenu.css')}}" rel="stylesheet" id="sidemenu-theme">

    <!--C3 CHARTS CSS -->
    <link href="{{asset('admin/assets/plugins/charts-c3/c3-chart.css')}}" rel="stylesheet"/>

    <!-- P-scroll bar css-->
    <link href="admin/assets/plugins/p-scroll/perfect-scrollbar.css" rel="stylesheet" />
			 ...
			 <div class="page-content error-page error2">
				 <div class="container text-center">
					 <div class="error-template">
                         ...
                         Sorry, an error has occurred. There is a problem with our server, and we are working to fix it!
						 </h5>
