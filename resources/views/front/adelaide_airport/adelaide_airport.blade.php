...
@section('title', 'Adelaide Guide - '.env('APP_NAME'))
          ...
          <div class="airport-ride">
            <div class="airport-ride-left">
              <div class="airport-ride-left-img map">
                ...
                <img src="{{asset('uploads/airportguide/'. $values->vImage)}}"  alt="airport-guide" class="img-fluid"
                  width="677" height="411">
                @else
                <img src="{{asset('front/assets/img/no_image.png')}}"  alt="airport-guide" class="img-fluid"
                  width="677" height="411">
                @endif
              </div>
            </div>
        ...
        <div class="mt-60 airport-ride-wrap">
          <div class="airport-ride">
            ...
            <div class="airport-ride-left">
              <div class="airport-ride-left-img map">
                @if($values->vImage != null && file_exists(public_path()."/uploads/airportguide/".$values->vImage))
                <img src="{{asset('uploads/airportguide/'. $values->vImage)}}"  alt="airport-guide" class="img-contain"  width="677" height="411">
                @else
                <img src="{{asset('front/assets/img/no_image.png')}}"  alt="airport-guide" class="img-contain"  width="677" height="411">
                @endif
              </div>
            </div>
          </div>
