...
@section('title', 'Canberra Guide - '.env('APP_NAME'))
          ...
          <div class="airport-ride">
            <div class="airport-ride-left">
              <div class="airport-ride-left-img map">
                <img src="{{asset('uploads/airportguide/'. $values->vImage)}}"


                alt="airport-guide" class="img-contain"
        ...
        <div class="mt-60 airport-ride-wrap">
          <div class="airport-ride">
            ...
            <div class="airport-ride-left">
              <div class="airport-ride-left-img map">
                <img src="{{asset('uploads/airportguide/'. $values->vImage)}}"
                alt="airport-guide" class="img-contain"  width="677" height="411">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="dow-btn-grup mt-40">
                        ...
                        target="_blank" class="dow-btn"><img src="{{asset('uploads/logo/'.$android_playstore_logo->vValue)}}" alt="dow-btn" title="Play Store"
                            class="img-fluid" width="165" height="45"></a>
                        @endif
                        ...
                        target="_blank" class="dow-btn"><img src="{{asset('uploads/logo/'.$apple_appstore_logo->vValue)}}" alt="dow-btn" title="App Store"
                            class="img-fluid" width="165" height="45"></a>
                        @endif
                    </div>
                    </div>
