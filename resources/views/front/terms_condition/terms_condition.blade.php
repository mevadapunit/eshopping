...
<div class="page-wrap py-60">
    <div class="container">
        <section class="terms-condition">
                ...
                @foreach($termsandconditions as $key=>$values)
                <div class="terms-condition-listing">
                    <br>
                    <h1 class="h3">
                        {{$values->vTitle}}
                    </h1>
                    <ul class="airport-ride-listing number">   <!--airport-ride-listing number -->
                     {!! $values->tDescription !!}
                    </ul>
                </div>
                @endforeach
                @endif
                <a href="#" rel="dofollow" class="read-more"> Read More...</a>
        </section>
