...
@section('title', 'Faq Listing- '.env('APP_NAME'))
@section('content')
...
<div class="d-flex gap-3 top-input-space">
        ...
        <div class="d-flex flex-wrap right-side-top">
            ...
            <div class="space">
                     <a href="{{url('admin/faq/add')}}" class="btn btn-primary">+ Add</a>
            </div>
            @endif
        </div>
    </div>
                  ...
                  <thead>
                     <tr>
                        ...
                        <th class="space-w"><input placeholder="Title" id="vTitle" type="text" name="vTitle" class="search form-control"></th>
                         <th class="space-w"><input placeholder="Type" id="vType" type="text" name="vType" class="search form-control"></th>
                        <th class="space-w"><select name="eUser" id="eUser" class="form-select">
...
<script type="text/javascript">
    ...
    function filter(vUniqueCode, vAction, vPages)
    {
        ...
        setTimeout(function() {
        $.ajax({
           url: "{{url('admin/faq/ajax_listing')}}",
           type: "POST",
           headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')},
           data: {vUniqueCode:vUniqueCode,vAction:vAction,pages:pages, eUser:eUser,vType:vType, vTitle:vTitle, eStatus_search:eStatus_search,eStatus:eStatus,eDeleted:eDeleted,eFeature_search:eFeature_search},
    ...
    $(document).on("change", "#eUser", function() {
        filter("", "search", "");
    });
