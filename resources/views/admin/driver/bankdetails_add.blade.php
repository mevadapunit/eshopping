      ...
      <div class="col-md-12">
          ...
          <div class="col-md-12">   
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link " href="{{route('admin.driver.edit',$driver_bankdetails->vUniqueCode)}}"
                        ><i class="bx bx-user me-1"></i> Profile</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link " href="{{url('admin/driver/tax_edit',$driver_bankdetails->vUniqueCode)}}"><i class='bx bx-receipt'></i> Tax Details</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="{{url('admin/driver/bankdetails_edit',$driver_bankdetails->vUniqueCode)}}"
                        ><i class="bx bx-link-alt me-1"></i> Bank Details</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link " href="{{url('admin/driver/vehicle_edit',$driver_bankdetails->vUniqueCode)}}"><i class="bx bx-car me-1"></i> Vehicle</a
                      >
                    </li>
                     <li class="nav-item">
                      <a class="nav-link" href="{{url('admin/driver/document_edit',$driver_bankdetails->vUniqueCode)}}"><i class='bx bx-file'></i> Document</a
                      >
                    </li>
                   <li class="nav-item">
                     <a class="nav-link" href="{{url('admin/driver/vehicle_images',$driver_bankdetails->vUniqueCode)}}"><i class='bx bx-image-add'></i>Vehicle Images</a
                      >
                   </li>
                   <li class="nav-item">
                     <a class="nav-link" href="{{url('admin/driver/training_video_verification',$driver_bankdetails->vUniqueCode)}}"><i class='bx bx-show-alt'></i>Video Status</a
                      >
                    </li>
                     <li class="nav-item">
                     <a class="nav-link" href="{{url('admin/driver/referral_code',$driver_bankdetails->vUniqueCode)}}"><i class='bx bxs-network-chart'></i>Raferral</a
                      >
                    </li>
                  </ul>
            <form action="{{url('admin/driver/bankdetails_store')}}" name="frm" id="frm" method="post"
               enctype="multipart/form-data">
               @csrf
             <div class="card mb-4">
               <div class="card-body">
                 <input type="hidden" id="vUniqueCode" name="vUniqueCode"
                     value="@if(isset($driver_bankdetails)){{$driver_bankdetails->vUniqueCode}}@endif">
                  <div class="row g-3">
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        <label>Account Holder Name</label>
                        <input type="text" name="vAccountHolderName" id="vAccountHolderName" class="form-control"
                           placeholder="Enter Account Holder Name"
                           value="@if(isset($driver_bankdetails)){{$driver_bankdetails->vAccountHolderName}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <input type="text" name="vBSB" id="vBSB" class="form-control"
                           ...
                           value="@if(isset($driver_bankdetails)){{$driver_bankdetails->vBSB}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <input type="text" name="vAccountNumber" id="vAccountNumber" class="form-control"
                           ...
                           value="@if(isset($driver_bankdetails)){{$driver_bankdetails->vAccountNumber}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                           <input class="form-control"
                              ...
                              placeholder="Enter Bank Name" value="@if(isset($driver_bankdetails)){{$driver_bankdetails->vBankName}}@endif"/>
                        </div>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <input type="text" name="vBranch" id="vBranch" class="form-control"
                           placeholder="Enter Branch" value="@if(isset($driver_bankdetails)){{$driver_bankdetails->vBranch}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                           <input class="form-control"
                              ...
                              placeholder="Enter Bank PostCode" value="@if(isset($driver_bankdetails)){{$driver_bankdetails->vBankPostCode}}@endif"/>
                        </div>
