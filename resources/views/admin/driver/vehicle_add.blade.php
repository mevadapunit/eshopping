          ...
          <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link " href="{{route('admin.driver.edit',$driver_vehicle->vUniqueCode)}}"
                        ><i class="bx bx-user me-1"></i> Profile</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link  " href="{{route('admin.driver.tax_edit',$driver_vehicle->vUniqueCode)}}"
                        ><i class='bx bx-receipt'></i> Tax Details</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('admin/driver/bankdetails_edit',$driver_vehicle->vUniqueCode)}}"
                        ><i class="bx bx-link-alt me-1"></i> Bank Details</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="{{url('admin/driver/vehicle_edit',$driver_vehicle->vUniqueCode)}}"><i class="bx bx-car me-1"></i> Vehicle</a
                      >
                    </li>
                     <li class="nav-item">
                      <a class="nav-link " href="{{url('admin/driver/document_edit',$driver_vehicle->vUniqueCode)}}"><i class='bx bx-file'></i>Document</a
                      >
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="{{url('admin/driver/vehicle_images',$driver_vehicle->vUniqueCode)}}"><i class='bx bx-image-add'></i>Vehicle Images</a
                      >
                    </li>
                    <li class="nav-item">
                     <a class="nav-link" href="{{url('admin/driver/training_video_verification',$driver_vehicle->vUniqueCode)}}"><i class='bx bx-show-alt'></i>Video Status</a
                      >
                    </li>
                     <li class="nav-item">
                     <a class="nav-link" href="{{url('admin/driver/referral_code',$driver_vehicle->vUniqueCode)}}"><i class='bx bxs-network-chart'></i>Raferral</a
                      >
                    </li>
                  </ul>
        
            <form action="{{url('admin/driver/vehicle_store')}}" name="frm" id="frm" method="post"
               enctype="multipart/form-data">
               @csrf
             <div class="card mb-4">
               <div class="card-body">
                  <input type="hidden" id="vUniqueCode" name="vUniqueCode"
                     value="@if(isset($driver_vehicle)){{$driver_vehicle->vUniqueCode}}@endif">
                  <div class="row g-3">
                    <!-- <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="iCompanyId" name="iCompanyId" class="form-select">
                            ...
                            <option value="{{$values->iCompanyId}}" @if(isset($driver_vehicle)) @if($driver_vehicle->iCompanyId == $values->iCompanyId) selected @endif @endif>{{$values->vCompany}}</option>
                            @endforeach
                        </select>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                           <input class="form-control"
                              ...
                              placeholder="Enter Register Number" value="@if(isset($driver_vehicle)){{$driver_vehicle->vRegisterNumber}}@endif"/>
                        </div>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                           <input class="form-control"
                              ...
                              placeholder="Enter Driving Licence Number" value="@if(isset($driver_vehicle)){{$driver_vehicle->vDrivingLicence}}@endif"/>
                        </div>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        <label>Driving Licence Verification</label>
                        <select name="eDrivingLicence" id="eDrivingLicence" class="form-select">
                           <option value="">Select Status</option>
                           <option value="Verified" @if(isset($driver_vehicle)) @if($driver_vehicle->eDrivingLicence == 'Verified')
                           selected @endif @endif>Verified</option>
                           <option value="Pending" @if(isset($driver_vehicle)) @if($driver_vehicle->eDrivingLicence ==
                           'Pending') selected @endif @endif>Pending</option>
                          
                        </select>
                         <div id="eDrivingLicence_error" class="error mt-1" style="color:red;display: none;">
                           Please Select Driving Licence Status
                         </div>
                    </div>
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                           <input class="form-control"
                              ...
                              placeholder="Enter VIN Number" value="@if(isset($driver_vehicle)){{$driver_vehicle->vVIN}}@endif"/>
                        </div>
                      ...
                      <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="iMakeId" name="iMakeId" class="form-select">
                            ...
                            <option value="{{$values->iMakeId}}" @if(isset($driver_vehicle)) @if($driver_vehicle->iMakeId == $values->iMakeId) selected @endif @endif>{{$values->vMake}}</option>
                            @endforeach
                        </select>
                       ...
                       <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="iModelId" name="iModelId" class="form-select">
                            ...
                            <option value="{{$values->iModelId}}" @if(isset($driver_vehicle)) @if($driver_vehicle->iModelId == $values->iModelId) selected @endif @endif>{{$values->vModel}}</option>
                            @endforeach
                        </select>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="iColorId" name="iColorId" class="form-select">
                            ...
                            <option value="{{$values->iColorId}}" @if(isset($driver_vehicle)) @if($driver_vehicle->iColorId == $values->iColorId) selected @endif @endif>{{$values->vColor}}</option>
                            @endforeach
                        </select>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="iYearId" name="iYearId" class="form-select">
                            ...
                            <option value="{{$value->iYearId}}" @if(isset($driver_vehicle)) @if($driver_vehicle->iYearId == $value->iYearId) selected @endif @endif>{{$value->vYear}}</option>
                            @endforeach
                        </select>
                       ...
                       <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="iVehicleTypeId" name="iVehicleTypeId" class="form-select">
                            ...
                            <option value="{{$value->iVehicleTypeId}}" @if(isset($driver_vehicle)) @if($driver_vehicle->iVehicleTypeId == $value->iVehicleTypeId) selected @endif @endif>{{$value->vVehicleType}}</option>
                            @endforeach
                        </select>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="iOwnershipTypeId" name="iOwnershipTypeId" class="form-select">
                            ...
                            <option value="{{$value->iOwnershipTypeId}}" @if(isset($driver_vehicle)) @if($driver_vehicle->iOwnershipTypeId == $value->iOwnershipTypeId) selected @endif @endif>{{$value->vOwnershipType}}</option>
                            @endforeach
                        </select>
...
<script type="text/javascript">  
   $(document).on('click', '.submit', function() {
       ...
       var eDrivingLicence   = $('#eDrivingLicence').val(); 
       ...
       if (eDrivingLicence.length == 0) {
           $("#eDrivingLicence_error").show();
           error = true;
       } else {
           $("#eDrivingLicence_error").hide();
       }
       if (vVIN.length == 0) {
           $("#vVIN_error").show();
           error = true;
