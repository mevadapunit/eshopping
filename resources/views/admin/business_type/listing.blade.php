...
@section('title', 'Business Type Listing - '.env('APP_NAME'))
@section('content')
<!-- Main content -->
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex gap-3 top-input-space">
        ...
        <div class="d-flex flex-wrap right-side-top">
            ...
            <div class="space">
                     <a href="{{url('admin/businesstype/add')}}" class="btn btn-primary">+ Add</a>
            </div>
            @endif
        </div>
               ...
               <table class="table table-bordered">
                  <thead>
                     <tr>
                        ...
                        <th><input placeholder="Business Type" id="vBusinessType" type="text" name="vBusinessType" class="search form-control"></th>
...
<script type="text/javascript">
    ...
    // function filter(vUniqueCode, vAction, vPage , vBusinessType , vCode , eStatus_search, eStatus)
    function filter(vUniqueCode, vAction, vPages)
    {
        ...
        setTimeout(function() {
        $.ajax({
           url: "{{url('admin/businesstype/ajax_listing')}}",
           type: "POST",
           headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')},
           data: {vUniqueCode:vUniqueCode, vAction:vAction, pages:pages, vBusinessType:vBusinessType, eStatus_search:eStatus_search,eStatus:eStatus,eDeleted:eDeleted, eFeature_search:eFeature_search,},
