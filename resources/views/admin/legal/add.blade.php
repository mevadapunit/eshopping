...
@if(isset($legals))
@section('title', 'Legal Edit- '.env('APP_NAME'))
@else
@section('title', 'Legal Add- '.env('APP_NAME'))
@endif
@section('content')
      ...
      <div class="col-md-12">
         <div class="row mb-2">
            <div class="col-sm-6 mt-2">
                <h5>{{ isset($legals) ? 'Edit' : 'Add' }} Legal</h5>
            </div>
         </div>
         <form action="{{url('admin/legal/store')}}" name="frm" id="frm" method="post"
               enctype="multipart/form-data">
               @csrf
              <div class="card mb-4">
                <div class="card-body">
                  <input type="hidden" id="vUniqueCode" name="vUniqueCode"
                     value="@if(isset($legals)){{$legals->vUniqueCode}}@endif">
                  <div class="row g-3">
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        <label>Title</label>
                        <input type="text" name="vTitle" id="vTitle" class="form-control"
                           placeholder="Enter Title"
                           value="@if(isset($legals)){{$legals->vTitle}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eFeature" id="eFeature" class="form-select">
                           ...
                           <option value="Yes" @if(isset($legals)) @if($legals->eFeature ==
                           'Yes') selected @endif @endif>Yes</option>
                           <option value="No" @if(isset($legals)) @if($legals->eFeature == 'No')
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="vController" name="vController" class="form-select">
                            ...
                            <option value="{{$value}}" @if(isset($legals)) @if($legals->vController == $value) selected @endif @endif>@php echo strstr($value, 'Controller', true);@endphp</option>
                            @endforeach
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eStatus" id="eStatus" class="form-select">
                           ...
                           <option value="Active" @if(isset($legals)) @if($legals->eStatus == 'Active')
                           selected @endif @endif>Active</option>
                           <option value="Inactive" @if(isset($legals)) @if($legals->eStatus ==
                           'Inactive') selected @endif @endif>Inactive</option>
                           <option value="Pending" @if(isset($legals)) @if($legals->eStatus ==
               ...
               <div class="card-footer col-12 align-self-end d-inline-block mt-0 text-left">
                  ...
                  <a href="{{url('admin/legal')}}" class="btn-info btn">Back</a>
               </div>
              </div>
            </form>
         </div>
