...
@section('title', 'Privacy Policy Edit- '.env('APP_NAME'))
@else
@section('title', 'Privacy Policy Add- '.env('APP_NAME'))
@endif
@section('content')
      ...
      <div class="col-md-12">
         <div class="row mb-2">
            <div class="col-sm-6 mt-2">
                <h5>{{ isset($privacypolicies) ? 'Edit' : 'Add' }} Privacy Policy</h5>
            </div>
         </div>
         <form action="{{url('admin/privacypolicy/store')}}" name="frm" id="frm" method="post"
               enctype="multipart/form-data">
               @csrf
              <div class="card mb-4">
                <div class="card-body">
                  <input type="hidden" id="vUniqueCode" name="vUniqueCode"
                     value="@if(isset($privacypolicies)){{$privacypolicies->vUniqueCode}}@endif">
                  <div class="row g-3">
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        <label>Title</label>
                        <input type="text" name="vTitle" id="vTitle" class="form-control"
                           placeholder="Enter Title"
                           value="@if(isset($privacypolicies)){{$privacypolicies->vTitle}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eFeature" id="eFeature" class="form-select">
                           ...
                           <option value="Yes" @if(isset($privacypolicies)) @if($privacypolicies->eFeature ==
                           'Yes') selected @endif @endif>Yes</option>
                           <option value="No" @if(isset($privacypolicies)) @if($privacypolicies->eFeature == 'No')
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eStatus" id="eStatus" class="form-select">
                           ...
                           <option value="Active" @if(isset($privacypolicies)) @if($privacypolicies->eStatus == 'Active')
                           selected @endif @endif>Active</option>
                           <option value="Inactive" @if(isset($privacypolicies)) @if($privacypolicies->eStatus ==
                           'Inactive') selected @endif @endif>Inactive</option>
                           <option value="Pending" @if(isset($privacypolicies)) @if($privacypolicies->eStatus ==
                     ...
                     <div class="form-group col-xl-12 col-lg-12 col-md-12">
                        ...
                        <textarea  name="tDescription" id="tDescription"  class="form-control"
                           ...
                           value="@if(isset($privacypolicies)){{$privacypolicies->tDescription}}@endif">@if(isset($privacypolicies)){{$privacypolicies->tDescription}}@endif</textarea> 
               ...
               <div class="card-footer col-12 align-self-end d-inline-block mt-0 text-left">
                  ...
                  <a href="{{url('admin/privacypolicy')}}" class="btn-info btn">Back</a>
               </div>
              </div>
            </form>
         </div>
