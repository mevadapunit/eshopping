...
@if(isset($states))
@section('title', 'State Edit- '.env('APP_NAME'))
@else
@section('title', 'State Add- '.env('APP_NAME'))
@endif
@section('content')
      ...
      <div class="col-md-12">
         <div class="row mb-2">
            <div class="col-sm-6 mt-2">
                <h5>{{ isset($states) ? 'Edit' : 'Add' }} State</h5>
            </div>
         </div>

         <form action="{{url('admin/state/store')}}" name="frm" id="frm" method="post"
               enctype="multipart/form-data">
               @csrf
            <div class="card mb-4">
                <div class="card-body">
                  <input type="hidden" id="vUniqueCode" name="vUniqueCode"
                     value="@if(isset($states)){{$states->vUniqueCode}}@endif">
                  <div class="row g-3">
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        <label>State</label>
                        <input type="text" name="vState" id="vState" class="form-control"
                           placeholder="Enter State"
                           value="@if(isset($states)){{$states->vState}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eFeature" id="eFeature" class="form-select">
                           ...
                           <option value="Yes" @if(isset($states)) @if($states->eFeature ==
                           'Yes') selected @endif @endif>Yes</option>
                           <option value="No" @if(isset($states)) @if($states->eFeature == 'No')
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eStatus" id="eStatus" class="form-select">
                           ...
                           <option value="Active" @if(isset($states)) @if($states->eStatus == 'Active')
                           selected @endif @endif>Active</option>
                           <option value="Inactive" @if(isset($states)) @if($states->eStatus ==
                           'Inactive') selected @endif @endif>Inactive</option>
                           <option value="Pending" @if(isset($states)) @if($states->eStatus ==
               ...
               <div class="card-footer col-12 align-self-end d-inline-block mt-0 text-left">
                  ...
                  <a href="{{url('admin/state')}}" class="btn-info btn">Back</a>
               </div>
             </div>
            </form>
        </div>
