...
@if(isset($ourpromises))
@section('title', 'Our Promises Edit- '.env('APP_NAME'))
@else
@section('title', 'Our Promises Add- '.env('APP_NAME'))
@endif
@section('content')
      ...
      <div class="col-md-12">
         <div class="row mb-2">
            <div class="col-sm-6 mt-2">
                <h5>{{ isset($ourpromises) ? 'Edit' : 'Add' }} Our Promises</h5>
            </div>
         </div>
         <form action="{{url('admin/ourpromises/store')}}" name="frm" id="frm" method="post"
               enctype="multipart/form-data">
               @csrf
              <div class="card mb-4">
                <div class="card-body">
                  <input type="hidden" id="vUniqueCode" name="vUniqueCode"
                     value="@if(isset($ourpromises)){{$ourpromises->vUniqueCode}}@endif">
                  <div class="row g-3">
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        <label>Title</label>
                        <input type="text" name="vTitle" id="vTitle" class="form-control"
                           placeholder="Enter Title"
                           value="@if(isset($ourpromises)){{$ourpromises->vTitle}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <textarea  name="tDescription" id="tDescription" class="form-control"
                           ...
                           value="@if(isset($ourpromises)){{$ourpromises->tDescription}}@endif">@if(isset($ourpromises)){{$ourpromises->tDescription}}@endif</textarea> 
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eFeature" id="eFeature" class="form-select">
                           ...
                           <option value="Yes" @if(isset($ourpromises)) @if($ourpromises->eFeature ==
                           'Yes') selected @endif @endif>Yes</option>
                           <option value="No" @if(isset($ourpromises)) @if($ourpromises->eFeature == 'No')
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eStatus" id="eStatus" class="form-select">
                           ...
                           <option value="Active" @if(isset($ourpromises)) @if($ourpromises->eStatus == 'Active')
                           selected @endif @endif>Active</option>
                           <option value="Inactive" @if(isset($ourpromises)) @if($ourpromises->eStatus ==
                           'Inactive') selected @endif @endif>Inactive</option>
                           <option value="Pending" @if(isset($ourpromises)) @if($ourpromises->eStatus ==
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                            ...
                            @if(isset($ourpromises) && $ourpromises->vImage !='' &&
                            file_exists(public_path()."/uploads/ourpromises/".$ourpromises->vImage))


                            <!-- for image -->
                            <img style="width: 100px; border-radius: 10px;margin-top: 7px;" id="image_display"
                                value="@if(old('vImage') == 'vImage') selected @endif"
                                src="{{asset('uploads/ourpromises/'.$ourpromises->vImage)}}">
                            
                            @elseif(isset($ourpromises))
                            <!-- default image -->
               ...
               <div class="card-footer col-12 align-self-end d-inline-block mt-0 text-left">
                  ...
                  <a href="{{url('admin/ourpromises')}}" class="btn-info btn">Back</a>
               </div>
              </div>
            </form>
            @if (count($errors) > 0)
