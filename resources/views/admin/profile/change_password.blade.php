                        ...
                        <div class="row g-3">
                           <div class="form-group col-lg-6 col-md-6 last">
                              <div class="form-group">
                                 ...
                                 <input type="password" class="form-control" id="vPassword" name="vPassword" placeholder="Password" value="@if(old('vPassword')!=''){{old('vPassword')}}@elseif(isset($admin->vNormalPassword)){{$admin->vNormalPassword}}@else{{old('vNormalPassword')}}@endif">
                              ...
                              <span class="pt-2" style="display:block;"><input type="checkbox" class="form-check-input" id="showPass" style="margin-right: 5px;">Show Password</span>
                           </div>
                           <div class="form-group col-lg-6 col-md-6 last">
                              <div class="form-group">
                                 <label>Confirm Password</label>
                                 <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Password" value="@if(old('confirm_password')!=''){{old('confirm_password')}}@elseif(isset($admin->confirm_password)){{$admin->confirm_password}}@else{{old('confirm_password')}}@endif">
