...
@if(isset($admin))
@section('title', 'Profile Edit- '.env('APP_NAME'))
@else
@section('title', 'Profile Add- '.env('APP_NAME'))
@endif
@section('content')
               ...
               <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="{{route('admin.admin.add')}}"
                        ><i class="bx bx-user me-1"></i>Personal Details</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link @if(!isset($admin)) disabled @endif " href="javascript:void(0)"><i class='bx bx-receipt'></i>Contact Details</a
                      >
                    </li>
                    @elseif(isset($admin->vUniqueCode))
                    <li class="nav-item">
                      <a class="nav-link " href="{{route('admin.edit',$admin->vUniqueCode)}}"
                        ><i class="bx bx-user me-1"></i>Personal Details</a
                      >
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link active @if(!isset($admin)) disabled @endif " href="{{route('admin.profile.address',$admin->vUniqueCode)}}"><i class='bx bx-receipt'></i>Contact Details</a
                      >
                    </li>
                    @endif
                  </ul>
