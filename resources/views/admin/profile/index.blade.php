...
@section('title', 'Profile Listing- '.env('APP_NAME'))
@section('content')
   ...
   <div class="row">
      <div class="col-md-12">
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="{{route('admin.edit',$admin->vUniqueCode)}}"
                        ><i class="bx bx-user me-1"></i>Personal Details</a
                      >
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link @if(!isset($admin)) disabled @endif " href="{{route('admin.profile.address',$admin->vUniqueCode)}}"><i class='bx bx-receipt'></i> Contact Details</a
                      >
                    </li>
                    @endif
                  </ul>
             ...
             <div class="card mb-4 ">
                    <div class="card-body login-count-section">
