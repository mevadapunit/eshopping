...
<tr>
   <td>
    ...
    <td class="text-center">
     @if($value->vFile !='' && file_exists(public_path()."/uploads/training_video/".$value->vFile))
     <a href="{{asset('/uploads/training_video/'.$value->vFile)}}" target="_blank">
     <video  style="width: 100px;border-radius: 10px;" controls >
        <source  src="{{asset('uploads/training_video/'.$value->vFile)}}">
    </video>
    </a>
    @else
    <div class="text-center">
     <img style="width: 100px;border-radius: 10px;" src="{{ asset('admin/assets/img/no_image.png') }}" alt="No photo">
    </div>
    @endif
   </td>
   ...
   <td>
      ...
      <div class="bottom-btn text-center">
         ...
         <a href="{{url('admin/trainingvideo/edit',$value->vUniqueCode)}}" data-toggle="tooltip_edit" title="Edit Data" data-id="{{$value->vUniqueCode}}" class="btn btn-outline-primary btn-sm me-1"><i class='bx bx-edit-alt pt-1 pb-1'></i></a>
         @endif
