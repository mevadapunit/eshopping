...
@if(isset($menues))
@section('title', 'Menu Edit- '.env('APP_NAME'))
@else
@section('title', 'Menu Add- '.env('APP_NAME'))
@endif
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
   <div class="row">
      <div class="col-md-12">
         ...
         <form action="{{url('admin/menu/store')}}" name="frm" id="frm" method="post"
            ...
            <div class="card mb-4">
               ...
               <div class="card-footer col-12 align-self-end d-inline-block mt-0 text-left">
                  ...
                  <a href="{{url('admin/menu')}}" class="btn-info btn">Back</a>
               </div>
              </div>
            </form>
        </div>
