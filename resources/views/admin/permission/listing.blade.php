...
@section('title', 'Permission Listing - '.env('APP_NAME'))
@section('content')
               ...
               <table class="table table-bordered">
                  <thead>
                     <tr>
                        ...
                        <th><select id="iModuleId" name="iModuleId"  data-live-search="true" class="form-select selectedmodule">
                         ...
                         <th><input placeholder="User Name" id="vKeyword" type="text" name="vKeyword" class="search form-control"></th>
...
<script type="text/javascript">
    ...
    function filter(vUniqueCode, vAction, vPages , iRoleId ,iModuleId ,eRead ,eWrite ,eDelete)
    {   
        var vUniqueCode      = vUniqueCode;
        var vAction          = vAction;
        var pages            = vPages;
        var iRoleId          = iRoleId;
        var iModuleId        = iModuleId;
        var eRead            = eRead;
        var eWrite           = eWrite;
        var eDelete          = eDelete;
        ...
        $.ajax({
           ...
           data: {vUniqueCode:vUniqueCode,iRoleId:iRoleId,iModuleId:iModuleId,vAction:vAction, pages:pages,eStatus:eStatus,vModule:vModule,vKeyword:vKeyword,vRole:vRole,eStatus:eStatus,eRead:eRead,eWrite:eWrite,eDelete:eDelete,},
    ...
    $(document).ready(function() {
     ...
     $(document).on("change", ".selectedrole", function() {
        ...
        var iModuleId  = $('#iModuleId :selected').val();
         filter("", "search", "",iRoleId,iModuleId,"","","","");
    });

      $(document).on("change", ".selectedmodule", function() {
        var iModuleId   = $(this).val();
