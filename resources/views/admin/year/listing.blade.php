...
@section('title', 'Year Listing- '.env('APP_NAME'))
@section('content')
...
<div class="d-flex gap-3 top-input-space">
        ...
        <div class="d-flex flex-wrap right-side-top">
            ...
            <div class="space">
                     <a href="{{url('admin/year/add')}}" class="btn btn-primary">+ Add</a>
            </div>
            @endif
        </div>
    </div>
               ...
               <table class="table table-bordered">
                  <thead>
                     <tr>
                        ...
                        <th><input placeholder="Year" id="vYear" type="text" name="vYear" class="search form-control"></th>
...
<script type="text/javascript">
    ...
    function filter(vUniqueCode, vAction, vPages)
    {
        ...
        setTimeout(function() {
        $.ajax({
           url: "{{url('admin/year/ajax_listing')}}",
           type: "POST",
           headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')},
           data: {vUniqueCode:vUniqueCode, vAction:vAction, pages:pages,vYear:vYear,eStatus_search:eStatus_search,eStatus:eStatus,eDeleted:eDeleted,eFeature_search:eFeature_search,},
