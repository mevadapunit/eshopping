...
@section('title', 'Pagination Edit- '.env('APP_NAME'))
@else
@section('title', 'Pagination Add- '.env('APP_NAME'))
@endif
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
   <div class="row">
      <div class="col-md-12">
         ...
         <form action="{{url('admin/pagination/store')}}" name="frm" id="frm" method="post"
             ...
             <div class="card mb-4">
               ...
               <div class="card-footer col-12 align-self-end d-inline-block mt-0 text-left">
                  ...
                  <a href="{{url('admin/pagination')}}" class="btn-info btn">Back</a>
               </div>
              </div>
            </form>
        </div>
