...
<div class="container-xxl flex-grow-1 container-p-y">
   <div class="row">
        <div class="col-md-12">
          ...
          <div class="card ">
            <form action="{{url('admin/rider/change_password_action')}}" name="frm" id="frm" method="post" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                ...
                <div class="row">
                       ...
                       <div class="form-group col-lg-6 col-md-6 last">
                          <div class="form-group">
                              ...
                              <input type="password" class="form-control" id="vPassword" name="vPassword" placeholder="Password" value="@if(old('password')!=''){{old('password')}}@elseif(isset($rider->vNormalPassword)){{$rider->vNormalPassword}}@else{{old('vNormalPassword')}}@endif">
                     ...
                     <div class="form-group col-lg-6 col-md-6 last">
                          <div class="form-group">
                              ...
                              <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Password" value="@if(old('confirm_password')!=''){{old('confirm_password')}}@elseif(isset($rider->confirm_password)){{$rider->confirm_password}}@else{{old('confirm_password')}}@endif">
