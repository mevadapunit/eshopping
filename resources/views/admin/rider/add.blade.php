...
@if(isset($rider))
@section('title', 'Rider Profile Edit- '.env('APP_NAME'))
@else
@section('title', 'Rider Profile Add- '.env('APP_NAME'))
@endif
@section('content')
   ...
   <div class="row">
      <div class="col-md-12">
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="{{route('admin.rider.edit',$rider->vUniqueCode)}}"
                        ><i class="bx bx-user me-1"></i> Profile</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link " href="{{url('admin/rider/tax_edit',$rider->vUniqueCode)}}"><i class='bx bx-receipt'></i> Tax Details</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('admin/rider/bankdetails_edit',$rider->vUniqueCode)}}"
                        ><i class="bx bx-link-alt me-1"></i> Bank Details</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('admin/rider/vehicle_edit',$rider->vUniqueCode)}}"
                        ><i class="bx bx-car me-1"></i> Vehicle</a
                      >
                    </li>
                  </ul>
                  @endif
          ...
          @endif
            ...
            <form action="{{url('admin/rider/store')}}" name="frm" id="frm" method="post"
               enctype="multipart/form-data">
               @csrf
            <div class="card mb-4">  
               <div class="card-body">
                  <input type="hidden" id="vUniqueCode" name="vUniqueCode"
                     value="@if(isset($rider)){{$rider->vUniqueCode}}@endif">
                  <input type="hidden" id="selected_iCityId" value="@if(isset($rider)){{$rider->iCityId}}@endif">
                  <div class="row g-3">
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        <label>First name</label>
                        <input type="text" name="vFirstName" id="vFirstName" class="form-control"
                           placeholder="Enter First Name"
                           value="@if(isset($rider)){{$rider->vFirstName}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <input type="text" name="vMiddleName" id="vMiddleName" class="form-control"
                           ...
                           value="@if(isset($rider)){{$rider->vMiddleName}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <input type="text" name="vLastName" id="vLastName" class="form-control"
                           ...
                           value="@if(isset($rider)){{$rider->vLastName}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                           <input class="form-control"
                              ...
                              placeholder="Enter Email" value="@if(isset($rider)){{$rider->vEmail}}@endif"/>
                        </div>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <input type="text" name="vPhone" id="vPhone" class="form-control"
                           placeholder="Enter Phone" value="@if(isset($rider)){{$rider->vPhone}}@endif">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <input class="form-control"  value="@if(old('dBirthDate')!=''){{old('dBirthDate')}}@elseif(isset($rider->dBirthDate)){{$rider->dBirthDate}}@else{{old('dBirthDate')}}@endif" type="date" name="dBirthDate" id="dBirthDate">
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select name="eGender" id="eGender" class="form-select">
                           ...
                           <option value="Male" @if(isset($rider)) @if($rider->eGender == 'Male')
                           selected @endif @endif>Male</option>
                           <option value="Female" @if(isset($rider)) @if($rider->eGender ==
                           'Female') selected @endif @endif>Female</option>
                           <option value="Other" @if(isset($rider)) @if($rider->eGender ==
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                        ...
                        <select id="iImmigrationStatusId" name="iImmigrationStatusId" class="form-select">
                            ...
                            <option value="{{$value->iImmigrationStatusId}}" @if(isset($rider)) @if($rider->iImmigrationStatusId == $value->iImmigrationStatusId) selected @endif @endif>{{$value->vImmigrationStatus}}</option>
                            @endforeach
                        </select>
                     ...
                     <div class="form-group col-xl-6 col-lg-12 col-md-6">
                            ...
                            @if(isset($rider) && $rider->vImage !='' &&
                            file_exists(public_path()."/uploads/user/".$rider->vImage))


                            <!-- for image -->
                            <img style="width: 100px; border-radius: 10px;margin-top: 7px;" id="image_display"
                                value="@if(old('vImage') == 'vImage') selected @endif"
                                src="{{asset('uploads/user/'.$rider->vImage)}}">
                            
                            @elseif(isset($rider))
                            <!-- default image -->
                            @if($rider->eGender != null)
                                @if($rider->eGender == "Male" || $rider->eGender == "Other")
                                 <div id="image_none">
                        ...
                        <div class="form-group col-xl-6 col-lg-12 col-md-6">
                            <label>Street Address</label>
                             <textarea class="form-control"  placeholder="Address" name="vAddress2" id="vAddress2" rows="3"  style="height: 72px;">@if(isset($rider)){{ $rider->vAddress2}} @endif</textarea>
                        ...
                        <div class="form-group col-xl-6 col-lg-12 col-md-6">
                            ...
                            <textarea class="form-control"  placeholder="Address" name="vAddress1" id="vAddress1" rows="3"  style="height: 72px;">@if(isset($rider)){{ $rider->vAddress1}} @endif</textarea>
                        ...
                        <div class="form-group col-xl-6 col-lg-12 col-md-6">
                           ...
                           <select id="iStateId" name="iStateId" class="form-select">
                               ...
                               <option value="{{$value->iStateId}}" @if(isset($rider)) @if($rider->iStateId == $value->iStateId) selected @endif @endif>{{$value->vState}}</option>
                               @endforeach
                           </select>
                        ...
                        <div class="form-group col-xl-6 col-lg-12 col-md-6">
                            ...
                            <input type="text" name="vZipCode" id="vZipCode" placeholder="Zipcode"  class="form-control"
                               value="@if(isset($rider)){{$rider->vZipCode}}@endif">
                            <div id="vZipCode_error" class="error mt-1" style="color:red;display: none;">
                               Please Enter Zipcode
                            </div>
                        </div>
                        <div class="form-group col-xl-12 col-lg-12">
                            <input class="form-check-input me-1" type="checkbox"  value="Yes" @if(isset($rider)) @if($rider->eAddressCheck =='Yes') checked @endif @endif  id="eAddressCheck" name="eAddressCheck">My Postal Address Same As Recidentaial Address
                        </div>
                        <div class="form-group col-xl-6 col-lg-12 col-md-6">
                            <label>Postal Address</label>
                            <textarea class="form-control"  placeholder="Address" name="vPostalAddress" id="vPostalAddress" rows="3"  style="height: 72px;">@if(isset($rider)){{ $rider->vPostalAddress}} @endif</textarea>
                        ...
                        <div class="form-group col-xl-6 col-lg-12 col-md-6">
                            ...
                            <input type="text" name="vPostCode" placeholder="Postcode" id="vPostCode" class="form-control"
                               value="@if(isset($rider)){{$rider->vPostCode}}@endif">
                        ...
                        <div class="form-group col-xl-6 col-lg-12 col-md-6">
                            ...
                            <input type="text" name="vPTD" id="vPTD" placeholder="Enter PTD Authentication number" class="form-control"
                               value="@if(isset($rider)){{$rider->vPTD}}@endif">
                        ...
                        <select name="eStatus" id="eStatus" class="form-select">
                           <option value="">Select Status</option>
                           <option value="Active" @if(isset($rider)) @if($rider->eStatus == 'Active')
                           selected @endif @endif>Active</option>
                           <option value="Inactive" @if(isset($rider)) @if($rider->eStatus ==
                           'Inactive') selected @endif @endif>Inactive</option>
                           <option value="Pending" @if(isset($rider)) @if($rider->eStatus ==
               ...
               <div class="card-footer col-12 align-self-end d-inline-block mt-0 text-left">
                  <a href="javascript:;" class="btn btn-primary submit_rider" id="save">Submit</a>
...
<script type="text/javascript">
   ...
   $(document).on('click', '.submit_rider', function() {
       ...
       var vPTD        = $("#vPTD").val();
       var iImmigrationStatusId = $("#iImmigrationStatusId").val();
