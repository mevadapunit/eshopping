...
@section('title', 'Subjective Listing- '.env('APP_NAME'))
@section('content')
...
<div class="d-flex gap-3 top-input-space">
        ...
        <div class="d-flex flex-wrap right-side-top">
            ...
            <div class="space">
                     <a href="{{url('admin/subjective/add')}}" class="btn btn-primary">+ Add</a>
            </div>
            @endif
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function filter(vUniqueCode, vAction, vPages)
    {
        ...
        setTimeout(function() {
        $.ajax({
           url: "{{url('admin/subjective/ajax_listing')}}",
           type: "POST",
           headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')},
           data: {vUniqueCode:vUniqueCode, vAction:vAction, pages:pages, eMenu:eMenu, vTitle:vTitle, eStatus_search:eStatus_search,eStatus:eStatus,eDeleted:eDeleted,eFeature_search:eFeature_search},
