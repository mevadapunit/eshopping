...
@if(isset($admin))
@section('title', 'Sub Admin Edit- '.env('APP_NAME'))
@else
@section('title', 'Sub Admin Add- '.env('APP_NAME'))
@endif
@section('content')
   ...
   <div class="row">
      <div class="col-md-12">
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="{{route('admin.subadmin.edit',$admin->vUniqueCode)}}"
                        ><i class="bx bx-user me-1"></i>Admin Profile</a
                      >
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link @if(!isset($admin)) disabled @endif " href="{{route('admin.subadmin.address_edit',$admin->vUniqueCode)}}"><i class='bx bx-receipt'></i> Address</a
                      >
                    </li>
                    @endif
                  </ul>
      
             <form action="{{url('admin/subadmin/store')}}" name="frm" id="frm" method="post"
            ...
            <div class="card mb-4">
               ...
               <div class="card-footer col-12 align-self-end d-inline-block mt-0 text-left">
                  ...
                  <a href="{{url('admin/subadmin')}}" class="btn-info btn">Back</a>
               </div>
            </div>
            </form>
