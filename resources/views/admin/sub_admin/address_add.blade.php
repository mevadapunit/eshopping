   ...
   <div class="row">
      <div class="col-md-12">
               <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link " href="{{route('admin.subadmin.edit',$admin->vUniqueCode)}}"
                        ><i class="bx bx-user me-1"></i>Admin Profile</a
                      >
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link active @if(!isset($admin)) disabled @endif " href="{{route('admin.subadmin.address_edit',$admin->vUniqueCode)}}"><i class='bx bx-receipt'></i> Address</a
                      >
                    </li>
                    @endif
                  </ul>
             <form action="{{url('admin/subadmin/address_store')}}" name="frm" id="frm" method="post"
