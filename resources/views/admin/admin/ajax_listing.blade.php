          ...
          <div class="card h-100 position-relative" style="box-shadow:0 3px 15px 5px #aaaaaa80;">
            ...
            <div class="card-body">
              ...
              <div class="bottom-btn">
                ...
                <a href="{{route('admin.admin.edit',$value->vUniqueCode)}}" data-toggle="tooltip_edit" title="Edit Account" data-id="{{$value->vUniqueCode}}" class="btn btn-outline-primary btn-sm"><i class='bx bx-edit-alt pt-1 pb-1'></i></a>
                @endif
                ...
                <a href="{{url('admin/admin/change_password',$value->vUniqueCode)}}" data-toggle="tooltip_password" title="Change Password" data-id="{{$value->vUniqueCode}}" class="btn btn-outline-info btn-sm"><i class='bx bx-lock-open-alt pt-1 pb-1'></i></a>
                @endif
              </div>
              @endif
            </div>
