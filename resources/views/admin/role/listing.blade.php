...
@section('title', 'Role Listing- '.env('APP_NAME'))
@section('content')
...
<div class="d-flex gap-3 top-input-space">
        ...
        <div class="d-flex flex-wrap right-side-top">
            ...
            <div class="space">
                     <a href="{{url('admin/role/add')}}" class="btn btn-primary">+ Add</a>
            </div>
            @endif
        </div>
    </div>
...
<script type="text/javascript">
    ...
    // function filter(vUniqueCode, vAction, vPage , vRole , vCode , eStatus_search, eStatus)
    function filter(vUniqueCode, vAction, vPages)
    {
        ...
        setTimeout(function() {
        $.ajax({
           url: "{{url('admin/role/ajax_listing')}}",
           type: "POST",
